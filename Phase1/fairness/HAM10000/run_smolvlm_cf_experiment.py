#!/usr/bin/env python3
"""
Counterfactual Fairness Experiment Script for SmolVLM on HAM10000 Dataset.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Counterfactual Fairness Experiment for SmolVLM on HAM10000")
    parser.add_argument(
        "--input_jsonl", 
        type=str, 
